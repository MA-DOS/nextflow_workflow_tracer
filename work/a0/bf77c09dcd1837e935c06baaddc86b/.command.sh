...
plot_macs2_qc.r \
    ...
    -s OSMOTIC_STRESS_T100_SE_REP2.mLb.clN,OSMOTIC_STRESS_T150_SE_REP1.mLb.clN,OSMOTIC_STRESS_T100_SE_REP1.mLb.clN,OSMOTIC_STRESS_T0_PE_REP2.mLb.clN,OSMOTIC_STRESS_T0_PE_REP1.mLb.clN,OSMOTIC_STRESS_T15_PE_REP1.mLb.clN \
